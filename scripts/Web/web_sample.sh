...
cat <<EOL
    ...
    <ul>
                <li><a href="#" class="load-file" data-file="${BASE_DIR}/Results/MultiQC/multiqc_report.html">MultiQC</a></li>
                <li><a href="#" class="load-file" data-file="${BASE_DIR}/Results/MultiSample_QC/multisampleBamQcReport.html">Alignment quality</a></li>
                 <li><a href="#" class="load-file" data-file="${BASE_DIR}/Results/Web/haplogroup.html">Haplogroup</a></li>
                 <li><a href="#" class="load-file" data-file="${BASE_DIR}/Results/Phylogenetic/tree.html">Phylogenetic tree</a></li>
                </ul>
...
if [[ -f "$FASTQC1" ]]; then
    echo "<li><a href=\"#\" class=\"load-file\" data-file=\"$FASTQC1\">Quality control #1 (FastQC)</a></li>"
fi

# FastQC Reverse
FASTQC2="${BASE_DIR}/Results/FastQC/${SAMPLE}/${SAMPLE}_2_fastqc.html"
if [[ -f "$FASTQC2" ]]; then
    echo "<li><a href=\"#\" class=\"load-file\" data-file=\"$FASTQC2\">Quality control #2 (FastQC)</a></li>"
fi

# Fastp
FASTP="${BASE_DIR}/Results/Fastp/${SAMPLE}/${SAMPLE}.html"
if [[ -f "$FASTP" ]]; then
    echo "<li><a href=\"#\" class=\"load-file\" data-file=\"$FASTP\">Quality control (Fastp)</a></li>"
fi

cat <<EOL
                <li><a href="#" class="load-file" data-file="${BASE_DIR}/Results/AlignmentQuality/${SAMPLE}/qualimapReport.html">Alignment quality</a></li>
...
EOL
    ...
    echo "<tr><td colspan='11'>No data available for sample ${SAMPLE}</td></tr>"
fi
